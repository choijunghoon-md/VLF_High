...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(L_Sonar_distance>=150 && L_Sonar_distance <= 300 && R_Sonar_distance >= 360){
      wall_fillowing1();
      }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    else if((R_Sonar_distance<=L_Sonar_distance+er && R_Sonar_distance>=L_Sonar_distance-er) && (F_Sonar_distance >200) &&(L_Sonar_distance <= 1000)){
      if(ck==0){
        while(1){
          index=read_line_sensor();
          read_sonar_sensor();
          Left(1,100);
          if((dw+er*3)>=L_Sonar_distance+R_Sonar_distance){
            break;
          }
