  ...
  unsigned long aAa1=0;
  unsigned long aAa2=0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    else if(L_Sonar_distance>=200 && L_Sonar_distance <= 300 && L_Sonar_distance >= 500){
      wall_fillowing1();
      }
    
    else if(dw+er*2>=R_Sonar_distance+L_Sonar_distance && (R_Sonar_distance<=L_Sonar_distance+er*2 && R_Sonar_distance >= L_Sonar_distance-er*2)){
      wall_fillowing1();
      adc=1;
      }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    else if((R_Sonar_distance<=L_Sonar_distance+er && R_Sonar_distance>=L_Sonar_distance-er) && index == 0){
      if(ck==0){
        while(1){
          index=read_line_sensor();
          read_sonar_sensor();
          Left(1,100);
          if(dw+er*2>=R_Sonar_distance+L_Sonar_distance || index != 0){
            break;
            adc=1;
          }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  int mode_line(void){
    ...
    if(F_Sonar_distance<=280 && index>=0){
      Right(1,100);
      delay(600);
      while(1){
        index=read_line_sensor();
...
void mode_mirro(void){
  if(F_Sonar_distance<=280){
        while(1){
        index=read_line_sensor();
        read_sonar_sensor();
        Serial.println(R_Sonar_distance+L_Sonar_distance);
        Right(1,100);
        if(280+er >=L_Sonar_distance || index !=0 ){
         // adc=0;
          break;
        }
       }
