...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(L_Sonar_distance>=200 && L_Sonar_distance <= 350 && R_Sonar_distance >= 500){
      wall_fillowing1();
      }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      if(ck==0){
        while(1){
          ...
          read_sonar_sensor();
          Left(1,100);
          if(dw+er*3>=R_Sonar_distance+L_Sonar_distance || index != 0){
            break;
            adc=1;
          }
...
void mode_mirro(void){
  if(F_Sonar_distance<=300){
        ...
        Right(1,100);
        if(300+er>=L_Sonar_distance || index !=0 ){
         // adc=0;
          break;
        }
       }
